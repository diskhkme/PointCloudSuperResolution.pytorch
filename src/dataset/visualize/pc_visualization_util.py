...
Date: November 2016
https://github.com/wuhuikai/PointCloudSuperResolution/blob/master/code/utils/pc_visulization_util.py
"""
import numpy as np
import cv2

from dataset.visualize.eulerangles import euler2mat
...
if __name__ == "__main__":
    points = np.loadtxt('../../../data/input/camel.xyz')
    im_array = point_cloud_three_views(points)
    im_array = im_array * 255.0
    cv2.imwrite('../../../data/input/camel.jpg',im_array)